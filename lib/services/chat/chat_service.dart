import 'package:chatappdemo/model/message.dart';
...
Future<void> sendMessage (String receiveId, String message) async{
  ...
  //construct chat room id from current userid and receiver id (sorted to ensure an uniqueness)
...
Stream<QuerySnapshot> getMessages(String userId, String otherUserId){
  //construct chat room id from user ids(sorted to ensure matchesthe idused when sending messages)
